...
public class DocumentServiceImpl implements DocumentService {
    ...
    @Override
    public DocumentDTO generatePdfDocumentByForm(Long templateId, List<VariableUpdateDTO> variables) {
        DocumentDTO documentDTO = new DocumentDTO();
        ...
        List<VariableResponseDTO> entities = variableEntityMapper.updateDtoToResponseDTOs(variables);

        templateVariableDTO.setVariables(entities);
